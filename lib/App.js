  ...
  render() {
    return (
      <div className='App'>
      {
        ...
        <Main data={this.state} onInitialSearch={this.onInitialSearch} onType={this.onType} onBackToHome={this.onBackToHome} /> :
        <StartPage data={this.state} onInitialSearch={this.onInitialSearch} onType={this.onType} />
      }
      </div>
    )
  }  
