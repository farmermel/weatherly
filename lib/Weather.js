  ...
  return (
    <article className="Weather">
      <section>
        ...
        <h1>{props.current.current_observation.temp_f}&#176;F</h1>
      </section>
      ...
      <article className="extremes">
        ...
        <section>
          ...
          <h2 className="current-extremes">{props.current.forecast.simpleforecast.forecastday[0].high.fahrenheit}&#176;F</h2>
        </section>
        <section>
          <h4 className="current-extremes">Low</h4>
          <h2 className="current-extremes">{props.current.forecast.simpleforecast.forecastday[0].low.fahrenheit}&#176;F</h2>
        </section>
      </article>
    </article>
  )
