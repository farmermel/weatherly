...
const Main = props => {
//once on main page, when you search again if there's an error
//the error isn't displayed it just stays where it is because it has data.currentObs
//it rerenders and then on rerender
  return (
    <div className="Main">
      <header className="header-wrapper">
      ...
      </header>
        {
          ...
          : (
              props.data.error ? <h3>{props.data.error}</h3> : 
              <img src={crystalBall} alt="loading..." />
            )
